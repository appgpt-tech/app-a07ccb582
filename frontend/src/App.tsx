...
import { BrandsList, BrandsCreate, BrandsEdit } from './resources/Brands';
import {
  WallpapersList,
  WallpapersCreate,
  WallpapersEdit,
} from './resources/Wallpapers';
import {
  CategoriesList,
  CategoriesCreate,
  CategoriesEdit,
} from './resources/Categories';
import BrandsIcon from '@mui/icons-material/LocalCarWash';
import WallpapersIcon from '@mui/icons-material/Wallpaper';
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/a07ccb582">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          name="Wallpapers"
          options={{ label: 'Wallpapers' }}
          list={WallpapersList}
          create={WallpapersCreate}
          edit={WallpapersEdit}
